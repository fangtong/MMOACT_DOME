#ifndef DBCP_IMPL_MYSQL_CONN_H
#define DBCP_IMPL_MYSQL_CONN_H
...
namespace SevenSmile{
	namespace DBCPFramework{
		namespace ImplBehaviors{
			...
			class ImplMySQLConnection
				:public IDBConnection<MYSQL_RES>
			{
			public:
				ImplMySQLConnection(WaitRes i_bEnableWaitRes=DISABLE_WAIT_RES);
				~ImplMySQLConnection(void);
