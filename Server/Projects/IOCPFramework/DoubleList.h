	...
	namespace Net{
		namespace IOCPFramework{
			...
			public:
				...
				T*					RemoveAt(T*			lp_t);
				void				RemoveAllAt(T*			lp_t);

				void				GetHeadPosition(ITERATOR& pos);
				T*					GetNext(ITERATOR& pos);
				void				GetEndPosition(ITERATOR& pos);
				T*					GetHead();
				T*					RemoveHead();
			...
			template<class T,int COUNT>
			void CDoubleList<T,COUNT>::RemoveAllAt(T* lp_t)
			{
			...
			---------------------------------------------------------------------------------*/
			template<class T,int COUNT>
			void CDoubleList<T,COUNT>::GetHeadPosition(ITERATOR& pos)
			{
				EnterCriticalSection( &m_critical_section );
			...
			template<class T,int COUNT>
			void CDoubleList<T,COUNT>::GetEndPosition(ITERATOR& pos)
			{
				EnterCriticalSection( &m_critical_section );
